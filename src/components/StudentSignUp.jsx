...
export default function StudentSignUp({ onBack, onClose, onOpenLogin }) {
  ...
  // ক্রম: students → teachers → admin_users
  // ============================================
  ...
  const handleGoToLogin = () => {
    ...
    onOpenLogin?.(existingEmail, 'student');
  };
